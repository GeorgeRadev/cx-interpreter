...
public enum Token {
	ERROR, EOF, EOL, NAME, NUMBER, STRING, L_PAREN, R_PAREN, COMMA, DOT, RETURN, EQ, NE, LT, LE, GT, GE, ADD, SUB, MUL, DIV, MOD, NOT, NEW, SEMICOLON, L_BRACKET, R_BRACKET, L_CURLY, R_CURLY, ASSIGN, ASSIGNOP, COLON, OR, AND, INCREMENT, DECREMENT, NULL, FALSE, TRUE, REGEXP, FUNCTION, IF, ELSE, SWITCH, CASE, DEFAULT, WHILE, DO, FOR, BREAK, CONTINUE, VAR, BIT_OR, BIT_AND, DELETE, QUESTION, BIT_XOR, BIT_LEFT, BIT_RIGHT, TRY, CATCH, FINALLY, THROW, COMPLEMENT, BIT_RIGHTU, NULL_VALUE;
